...
namespace CryEngine
{
	public struct Vector3
	{
        ...
        public Vector3 rotate_vector_by_quaternion(Quaternion q)
        {
            Vector3 v = this;
        ...
        public static float AngleInRad(Vector3 vec1, Vector3 vec2)
        {
            ...
            return AngleBetween(vec1,vec2,false);
        }

        //This returns the angle in degrees
        public static float AngleInDeg(Vector3 vec1, Vector3 vec2)
        {
            //return AngleInRad(vec1, vec2) * 180 / (float)Math.PI;
            return AngleBetween(vec1, vec2, true);
        }
        public static float AngleBetween(Vector3 u, Vector3 v, bool returndegrees)
        {
            float toppart = 0;
            ...
            if (returndegrees) rtnval *= 360.0f / (2 * (float)Math.PI);
            return rtnval;
        }
