...
namespace cgfFixer
{
      ...
      class Utils
    {
        ...
        public static short tPackF2B(  float f)
        {
            return (short)(f* 32767.0f);
        }
        public static float tSmallPackB2F(sbyte i)
        {
            return (float)(i / 128.0f);
        }
        public static sbyte tSmallPackF2B(float f)
        {
            return (sbyte)(f * 128);
        }
        public static float tPackUS2F(ushort i)
        {
           // return (float)(((float)(i/2) - 32768.0f)/ 32767.0f);
            return (float)(((float)i - 32768.0f) / 32767.0f);
        }
        //public static short tPackF2US(float f)
        //{
        //    return (short)(f * 32767.0f);
        //}
        public static float tSmallPackUB2F(byte i)
        {
            //if (i == 255) return 0;
            return ((i - 128.0f )/ 128f);
        }
        //public static byte tSmallPackF2UB(float f)
        //{
        //    return (byte)(f * 127.0f);
        //}

        public static float copySign(float origNum, sbyte copyFrom)
        {
            int copyFromSign = Math.Sign(copyFrom);
            if (copyFromSign == 0) copyFromSign = 1;
            int origNumSign = Math.Sign(origNum);
             
            if (copyFromSign == 1 && origNumSign == -1) return origNum * (-1.0f);
            if (copyFromSign == -1 && origNumSign == 1) return origNum * (-1.0f);
        ...
        public static TSpace VSassembly(Vector3 positions, uint tangentHex, uint bitangentHex,bool debug = false)
        {
            ...
            //REGISTERS
            Vector4 v0 = new Vector4(0, 0, 0, 0), v1 = new Vector4(0, 0, 0, 0), v2 = new Vector4(0, 0, 0, 0), v3 = new Vector4(0, 0, 0, 0), v4 = new Vector4(0, 0, 0, 0), v5 = new Vector4(0,0,0,0);
            Vector4 r0 = new Vector4(0, 0, 0, 0), r1 = new Vector4(0, 0, 0, 0), r2 = new Vector4(0, 0, 0, 0), r3 = new Vector4(0, 0, 0, 0);
            Vector4 o0 = new Vector4(0, 0, 0, 0), o1 = new Vector4(0, 0, 0, 0), o3 = new Vector4(0, 0, 0, 0), o4 = new Vector4(0, 0, 0, 0), o5 = new Vector4(0, 0, 0, 0);
            ...
            r1.x = positions.x; r1.y = positions.y; r1.z = positions.z; if (debug) Console.WriteLine("1: r1.x: {0} r1.y: {1} r1.z: {2}", r1.x, r1.y, r1.z);
            ...
            r3.x = new Vector3(InstanceBufferRaw0.z, InstanceBufferRaw0.y, InstanceBufferRaw0.x).Dot(new Vector3(r0.x, r0.z, r0.w)); if (debug) Console.WriteLine("29: r3.x: {0} | r0.x {1} r0.y {2} r0.z {3} r0.w {4}", r3.x, r0.x, r0.y, r0.z, r0.w);
            //r3.y = dot(InstanceBuffer[r2.x]._m12_m10_m11, r0.xzw);
            r3.y = new Vector3(InstanceBufferRaw1.z, InstanceBufferRaw1.y, InstanceBufferRaw1.x).Dot(new Vector3(r0.x, r0.z, r0.w)); if (debug) Console.WriteLine("30: r3.y: {0}", r3.y);
            //r3.z = dot(InstanceBuffer[r2.x]._m22_m20_m21, r0.xzw);
            r3.z = new Vector3(InstanceBufferRaw2.z, InstanceBufferRaw2.y, InstanceBufferRaw2.x).Dot(new Vector3(r0.x, r0.z, r0.w)); if (debug) Console.WriteLine("31: r3.z: {0}", r3.z);
            r1.w = new Vector3(r3.x, r3.y, r3.z).Dot(new Vector3(r3.x, r3.y, r3.z)); if (debug) Console.WriteLine("32: r1.w: {0}", r1.w);//r1.w = dot(r3.xyz, r3.xyz);
            ...
            r3.x = new Vector3(InstanceBufferRaw0.x, InstanceBufferRaw0.y, InstanceBufferRaw0.z).Dot(new Vector3(r1.x, r1.y, r1.z)); if (debug) Console.WriteLine("39: r3.x: {0}", r3.x);//r3.x = dot(InstanceBuffer[r2.x]._m00_m01_m02, r1.xyz);
            r3.y = new Vector3(InstanceBufferRaw1.x, InstanceBufferRaw1.y, InstanceBufferRaw1.z).Dot(new Vector3(r1.x, r1.y, r1.z)); if (debug) Console.WriteLine("40: r3.y: {0}", r3.y);//r3.y = dot(InstanceBuffer[r2.x]._m10_m11_m12, r1.xyz);
            r3.z = new Vector3(InstanceBufferRaw2.x, InstanceBufferRaw2.y, InstanceBufferRaw2.z).Dot(new Vector3(r1.x, r1.y, r1.z)); if (debug) Console.WriteLine("41: r3.z: {0}", r3.z);//r3.z = dot(InstanceBuffer[r2.x]._m20_m21_m22, r1.xyz);
            r0.y = new Vector3(new Vector3(r3.x, r3.y, r3.z)).Dot(new Vector3(r3.x, r3.y, r3.z)); if (debug) Console.WriteLine("42: r0.y: {0}", r0.y);//r0.y = dot(r3.xyz, r3.xyz);
